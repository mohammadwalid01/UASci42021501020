    ...
    <div class="table-responsive d-flex flex-column">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>SUNAN KUDUS <b>09</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i
                                class="material-icons">&#xE147;</i> <span>TAMBAH</span></a>
                        <a href="#" class="delete_all_data btn btn-danger"><i class="material-icons">&#xE15C;</i>
                            <span>Delete</span></a>
                    </div>
                </div>
            </div>
...
?>
                    <tr>
                        <input type="hidden" id="usersId" name="id" value="<?php echo $users['id']; ?>" />
                        <td>
                            <span class="custom-checkbox">
